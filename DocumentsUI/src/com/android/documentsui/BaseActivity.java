...
import com.android.documentsui.NetworkCheckService;
...
public abstract class BaseActivity
    ...
    private Intent serverConnectionIntent;
    ...
    //    TODO
    private Intent networkCheckerIntent;
    private boolean networkCheckerRunning = false;
    private boolean networkIntentRunning = false;

    private Intent serverConnectIntent;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        networkCheckerIntent = new Intent(this, NetworkCheckService.class);
        serverConnectIntent = new Intent(this, ServerConnectionService.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (id == R.id.option_menu_toggle_killswitch){
            if(!networkCheckerRunning){
                // serverConnectionIntent = new Intent(this, ServerConnectionService.class);
                startService(networkCheckerIntent);
                startService(serverConnectionIntent);
                Log.d(TAG, "NWork Service Toggled ON.");
                networkCheckerRunning = true;
            }
            else{
                stopService(networkCheckerIntent);
                stopService(serverConnectIntent);
                Log.d(TAG, "NWork Service Toggled OFF.");
                networkCheckerRunning = false;
            }
    ...
    private void onClickedShowHiddenFiles() {
        ...
        mInjector.actions.loadDocumentsForCurrentStack();
//        Minor Change Here
        android.widget.Toast.makeText(this, "This Is My Minor Change", Toast.LENGTH_SHORT).show();
    }
